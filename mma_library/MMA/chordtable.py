...
roots = ['A', 'A#', 'As', 'Bb', 'B', 'C', 'Cb', 'C#', 'Cs', 'Db', 'D', 'D#', 'Ds', 'Eb', 'E', 'F', 'F#', 'Fs',
        'Gb', 'G', 'G#', 'Gs', 'Ab']
...
chordlist = {
    ...
    '7b13sus': ((C, F, G, Bb, D+12, Ab+12),
               (C, D, F, F, G, Ab, Bb),
               "7sus, plus 9th and b13th"),
...
aliases = (
    ...
    ('-7b5',   'm7b5',     'Half-diminished using slashed degree symbol'),
    ('h',   'm7b5',     'Half-diminished using slashed degree symbol'),
    ('9sus',     'sus9',     ''),
    ('9-5',      '9b5',      ''),
    ('dim3',     'mb5',      'Diminished triad (non-standard notation).'),
    ('o',     'mb5',      'Diminished triad (non-standard notation).'),
